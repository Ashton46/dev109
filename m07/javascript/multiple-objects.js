...
var sunsetHotel = new Hotel('Sunset', 120, 77);
...
var details1 = sunsetHotel.name + ' rooms: ';
    details1 += sunsetHotel.checkAvailability();
var elHotel1 = document.getElementById('hotel3');
